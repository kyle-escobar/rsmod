...
import gg.rsmod.game.drops.DropTableDecoder
import gg.rsmod.game.drops.model.DropTable
import gg.rsmod.game.model.combat.NpcCombatDef
import gg.rsmod.game.model.drops.NpcDropTableDef
...
class NpcDropTableBuilder {
    private var drop_table_path: String = ""

    private var default_drop_table: Int = -1

    fun build(): NpcDropTableDef {
        val dropTable: DropTable = DropTableDecoder.decodeFile(this.drop_table_path)
        return NpcDropTableDef(dropTable)
    }

    fun setFile(path: String) {
        this.drop_table_path = path
    }

    fun setDefaultDroptable(id: Int) {
        this.default_drop_table = id
    }
}